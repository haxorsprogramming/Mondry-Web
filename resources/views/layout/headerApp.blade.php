...
<head>
    ...
    <link href="http://s3.jagoanstorage.com/aditia-storage/lib/datatable/datatables.min.css" rel="stylesheet">
    <link href="http://s3.jagoanstorage.com/aditia-storage/lib/select2/select2.min.css" rel="stylesheet">
        ...
        ***********************************-->
        <div class="nav-header">
            <a href="index.html" class="brand-logo">
                <img class="logo-abbr" src="{{ asset('/ladun/lib/acara') }}/images/logo.png" alt="">
                <img class="logo-compact" src="{{ asset('/ladun/lib/acara') }}/images/logo-text.png" alt="">
                <img class="brand-title" src="{{ asset('/ladun/lib/acara') }}/images/logo-text.png" alt="">
            </a>
                        ...
                        <ul class="navbar-nav header-right">
                                            ...
                                            <li>
                                                <div class="timeline-panel">
                                                    <div class="media mr-2">
                                                        <img alt="image" width="50" src="{{ asset('/ladun/lib/acara') }}/images/avatar/1.jpg">
                                                    </div>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:void(0)" role="button" data-toggle="dropdown">
                                    <img src="{{ asset('/ladun/lib/acara') }}/images/profile/17.jpg" width="20" alt="" />
